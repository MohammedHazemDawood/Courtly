        ...
        Column(
            ...
            Text(
                text = buildAnnotatedString {
                    val linkStyle =
                        notesTextStyle.copy(color = MaterialTheme.colorScheme.primary).toSpanStyle()
...
fun SignButton(
    ...
    Button(onClick = onClick, modifier = modifier, shape = MaterialTheme.shapes.medium) {
        Row(
            modifier = Modifier.fillMaxWidth().padding(LocalDimensions.current.xxSmall),
            verticalAlignment = Alignment.CenterVertically,
...
fun SignOptionsScreenPreview() {
    CourtlyTheme { SignOptionsScreen(googleSignIn = {}, navToEmailSign = {}) }
}